...
public class Pusher {
	 ...
	 */
	private final static String pusherApplicationId = Credential.PusherAppID;

	/**
	 * Pusher Application Key
	 */
	private final static String pusherApplicationKey = Credential.PusherKey;

	/**
	 * Pusher Secret
	 */
	private final static String pusherApplicationSecret = Credential.PusherSecret;
